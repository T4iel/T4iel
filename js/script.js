// T4iel Lab Portal - Central Logic & Shared Layout Injection

document.addEventListener("DOMContentLoaded", () => {
    console.log("T4iel Lab website initialized.");

    // 1. Inject Shared Navbar and Footer
    loadSharedLayout();

    // 2. Initialize Course Connection Graph if on homepage
    initCourseChart();
});
